...
public class WishListPage extends BasePage{
	...
	public void searchWishLists(){
		getFirstName().sendKeys(dataFactory.customersData().getFirstName());
		getLastName().sendKeys(dataFactory.customersData().getLastName());
		getSearchWishLists().click();
	}
	// clicks the delete wish list, asserts the next link is present, then deletes the wish list
	public void deleteWishList() {
		getWishDelete().click();
		wait.until(ExpectedConditions.elementToBeClickable(getWishDeleteConfirm()));
